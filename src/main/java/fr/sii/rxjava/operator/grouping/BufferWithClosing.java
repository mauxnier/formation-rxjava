...
public class BufferWithClosing {

    public static void main(String... args) {
        Observable<Integer> ints1 = createColdIntsObservable(10, 10, "Ints 1", RED, 0, 5);

        Observable<Integer> closing = createColdIntsObservable(200, 10, "Closing", ORANGE, 10, 10);

        createObserver(10, 350, "Observer", GREEN, ints1.buffer(() -> closing));
    }
}
